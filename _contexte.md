...
textes : Dans la section "Le coeur de lifeOS", mets juste en gros "le verrou de focus". Enlève "pas une notification au moins zéro qui ne sert à rien"
 ensuite voilà quoi écrire pour le texte explicatif : " tu regardes ton planning, tu choisis une tâche et tu  active le mode focus.  a partir de là tu ne peux utiliser que les  Application  Essentiel que tu as défini, tout le reste est bloqué. Ton téléphone est véritablement en toi et chaque tentative de fuite te ramène à l'écran de blocage et est comptée. "

 laisse le cadre avec les cadres étapes. Enlève juste "la certification, coche le bloc automatiquement" dans le quatrième bloc. 

 dans l'onglet des stricks, tu peux ajouter : enlève la constance de bien visible 